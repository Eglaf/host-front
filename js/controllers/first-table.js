(function () {
    ...
    app.controller('FirstTableCtrl', [
        '$scope', '$stateParams', '$timeout', '$filter', '_log', '_func', '_table', 'aoTableContent',
        function ($scope, $stateParams, $timeout, $filter, _log, _func, _table, aoTableContent) {
